...
Thereby, you have to **tune a bunch of PID controllers** and we will assign you points incrementally as you meet the following requirements in the case of **the jumping ball**:
